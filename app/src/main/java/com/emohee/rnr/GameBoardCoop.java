...
public class GameBoardCoop extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.game_board_coop);

        initBoard(gameMode, boardType, boardSize, R.drawable.mb_stx_5033);

        setListeners();

        msgToPlayers = findViewById(R.id.game_board_coop_msg_to_players);
        player1TurnIndicator1 = findViewById(R.id.game_board_coop_player1_turn_indicator1);
        player2TurnIndicator1 = findViewById(R.id.game_board_coop_player2_turn_indicator1);
        player1TurnIndicator1.setVisibility(View.VISIBLE);
        player1TurnIndicator2 = findViewById(R.id.game_board_coop_player1_turn_indicator2);
        player2TurnIndicator2 = findViewById(R.id.game_board_coop_player2_turn_indicator2);
        player1TurnIndicator2.setVisibility(View.VISIBLE);

        showMessageToPlayer(msgToPlayers, "Player One, Let's Go!");
    ...
    private void initBoard(String gameMode, String boardType, int boardSize, int clownPicIdentifier) {
        ...
        pics = new ArrayList<>();
        pics.add(findViewById(R.id.game_board_coop_metaboy_pic1));
        pics.add(findViewById(R.id.game_board_coop_metaboy_pic2));
        pics.add(findViewById(R.id.game_board_coop_metaboy_pic3));
        pics.add(findViewById(R.id.game_board_coop_metaboy_pic4));
        pics.add(findViewById(R.id.game_board_coop_metaboy_pic5));
        pics.add(findViewById(R.id.game_board_coop_metaboy_pic6));
        pics.add(findViewById(R.id.game_board_coop_metaboy_pic7));
        pics.add(findViewById(R.id.game_board_coop_metaboy_pic8));
        pics.add(findViewById(R.id.game_board_coop_metaboy_pic9));
        pics.add(findViewById(R.id.game_board_coop_metaboy_pic10));
        pics.add(findViewById(R.id.game_board_coop_metaboy_pic11));
        pics.add(findViewById(R.id.game_board_coop_metaboy_pic12));
        pics.add(findViewById(R.id.game_board_coop_metaboy_pic13));
        pics.add(findViewById(R.id.game_board_coop_metaboy_pic14));
        pics.add(findViewById(R.id.game_board_coop_metaboy_pic15));
        ...
        picCovers.add(findViewById(R.id.game_board_coop_metaboy_pic_cover1));
        picCovers.add(findViewById(R.id.game_board_coop_metaboy_pic_cover2));
        picCovers.add(findViewById(R.id.game_board_coop_metaboy_pic_cover3));
        picCovers.add(findViewById(R.id.game_board_coop_metaboy_pic_cover4));
        picCovers.add(findViewById(R.id.game_board_coop_metaboy_pic_cover5));
        picCovers.add(findViewById(R.id.game_board_coop_metaboy_pic_cover6));
        picCovers.add(findViewById(R.id.game_board_coop_metaboy_pic_cover7));
        picCovers.add(findViewById(R.id.game_board_coop_metaboy_pic_cover8));
        picCovers.add(findViewById(R.id.game_board_coop_metaboy_pic_cover9));
        picCovers.add(findViewById(R.id.game_board_coop_metaboy_pic_cover10));
        picCovers.add(findViewById(R.id.game_board_coop_metaboy_pic_cover11));
        picCovers.add(findViewById(R.id.game_board_coop_metaboy_pic_cover12));
        picCovers.add(findViewById(R.id.game_board_coop_metaboy_pic_cover13));
        picCovers.add(findViewById(R.id.game_board_coop_metaboy_pic_cover14));
        picCovers.add(findViewById(R.id.game_board_coop_metaboy_pic_cover15));
                        ...
                        if (gameTurns.successfulMatchInLatestTurn()) {
                            ...
                            for (int i = 0; i < pickPositionsInLatestTurn.size(); i++) {
                                ...
                                if (tempPosition == clownPosition) {
                                    ...
                                    showMessageToPlayer(msgToPlayers, "The strange clown disappeared!");
    ...
    private void gameEnds() {
        ...
        Long shortestTimeTaken = sharedPref.getLong(AppHelper.GAME_MODE2_SHORTEST_TIME_TAKEN, 0);
        int leastTurnsTaken = sharedPref.getInt(AppHelper.GAME_MODE2_LEAST_TURNS_TAKEN, 0);

        if ((shortestTimeTaken == 0) || (timeInMillis < shortestTimeTaken)) {
            editor.putLong(AppHelper.GAME_MODE2_SHORTEST_TIME_TAKEN, timeInMillis);
            editor.apply();
            timeTakenIsRecord = true;
        }

        if ((leastTurnsTaken == 0) || (turnsTaken < leastTurnsTaken)) {
            editor.putInt(AppHelper.GAME_MODE2_LEAST_TURNS_TAKEN, turnsTaken);
            editor.apply();
        ...
        gameEndTitle.setText("Great Co-op !");
